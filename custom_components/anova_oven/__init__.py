...
async def async_setup(hass: HomeAssistant, config: ConfigType) -> bool:
    ...
    async def start_cook(call: ServiceCall):
        ...
        if call.data["souse_vide"] and call.data["target_temperature"] > 100:
            raise ValueError(
        ...
        preheat_stage = APOStage(
            ...
            temperature_bulbs=APOStage.TemperatureBulbs(
                ...
                if call.data["souse_vide"]
                else None,
                mode="wet" if call.data["souse_vide"] else "dry",
            ),
